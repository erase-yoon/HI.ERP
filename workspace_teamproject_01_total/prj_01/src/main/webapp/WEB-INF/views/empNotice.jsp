<!-- JSP아래 기술의 한 종류인 [Page Directive]를 이용하여 현 JSP 페이지 처리 방식 선언하기 -->
  ...
  <div id="wrapper">
      ...
      <div class="tab-contents" data-tab-contents="DEFAULT" data-tab-contents-group="SIDE_MENU">
        ...
        <ul class="menu-accordion">
          ...
          <li class="tree-view">
            ...
            <ul class="tree-view-menu">
              <li><a href="empSalaryPwd.do"><span class="label">급여명세서조회</span></a></li>
    ...
    <div id="contents-wrapper">
      ...
      <table class="table table-md table-top">
        ...
        <tr onClick="goEmpNoticeDetail(${board.b_no})">
          <th>
