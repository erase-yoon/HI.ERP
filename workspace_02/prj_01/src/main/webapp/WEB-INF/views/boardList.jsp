...
<html>
    <head>
		...
		<script>
			...
			function init(){
                ...
                */
                ...
                <c:if test="${!empty param.min_year}">
			        ...
			        formObj1.find(".min_year").val("${param.min_year}");
		        </c:if>
                ...
                <c:if test="${!empty param.min_month}">
			        ...
			        formObj1.find(".min_month").val("${param.min_month}");
		        </c:if>
                ...
                <c:if test="${!empty param.max_year}">
			        ...
			        formObj1.find(".max_year").val("${param.max_year}");
		        </c:if>
                ...
                <c:if test="${!empty param.max_month}">
			        ...
			        formObj1.find(".max_month").val("${param.max_month}");
		        </c:if>
                ...
                <c:forEach var="date" items="${paramValues.date}">
                    formObj1.find(".date").filter("[value=${date}]").prop("checked", true);
                </c:forEach>

			}

            // name="boardRegForm" 태그 내부의 입력양식으로 
            // [name=boardSearchForm]"의 입력양식 복사
            function searchForm_to_regfom(){
                clone(formObj2.find(".selectPageNo"), formObj1.find(".selectPageNo"));
                formObj2.find(".selectPageNo").val(formObj1.find(".selectPageNo").val());
                formObj2.find(".rowCntPerPage").val(formObj1.find(".rowCntPerPage").val());
                formObj2.find(".keyword1").val(formObj1.find(".keyword1").val());
                formObj2.find(".keyword2").val(formObj1.find(".keyword2").val());
                formObj2.find(".min_year").val(formObj1.find(".min_year").val());
                formObj2.find(".min_month").val(formObj1.find(".min_month").val());
                formObj2.find(".max_year").val(formObj1.find(".max_year").val());
                formObj2.find(".max_month").val(formObj1.find(".max_month").val());
                formObj2.find(".min_year_month").val(formObj1.find(".min_year_month").val());
                //----------------------------------------------------
                formObj2.find(".max_year_month").val(formObj1.find(".max_year_month").val());
                formObj2.find(".sort").val(formObj1.find(".sort").val());
                //----------------------------------------------------
                formObj1.find(".date").each(function(i){
                    formObj2.find(".date").eq(i).prop("checked", $(this).is(":checked"));
                });
            }
            ...
            function goBoardRegForm(){
                ...
                // <input type="hidden" name="keyword1" class="keyword1" id="">
            ...
            // 클릭한 행의 b_no가 매개변수로 들어온다.
                ...
                formObj3.find(".selectPageNo").val(formObj1.find(".selectPageNo").val());
                formObj3.find(".rowCntPerPage").val(formObj1.find(".rowCntPerPage").val());
                formObj3.find(".keyword1").val(formObj1.find(".keyword1").val());
                formObj3.find(".keyword2").val(formObj1.find(".keyword2").val());
                formObj3.find(".min_year").val(formObj1.find(".min_year").val());
                formObj3.find(".min_month").val(formObj1.find(".min_month").val());
                formObj3.find(".max_year").val(formObj1.find(".max_year").val());
                formObj3.find(".max_month").val(formObj1.find(".max_month").val());
                //----------------------------------------------------
                formObj3.find(".min_year_month").val(formObj1.find(".min_year_month").val());
                formObj3.find(".max_year_month").val(formObj1.find(".max_year_month").val());
                formObj3.find(".sort").val(formObj1.find(".sort").val());
                //----------------------------------------------------
                formObj1.find(".date").each(function(i){
                    formObj3.find(".date").eq(i).prop("checked", $(this).is(":checked"));
                });
                ...
                formObj2.find("[name=b_no]").val(b_no);
    ...
    <body bgcolor="${requestScope.bodycolor}">
        ...
        <form action="/boardList.do" name="boardSearchForm" method="post">
            ...
            <div class="searchingResults">
                <table border="0" cellspacing="0" cellpadding="5" style="border-collapse: collapse;" align="center">
                    ...
                    <tr bgcolor="${requestScope.headerColor}">
                        <th>번호</th>
