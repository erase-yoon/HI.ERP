...
<head>
  ...
  <script>
    ...
    function checkRegForm(){
      ...
      var emp_retire = emp_retireObj.val();

      //사원번호 유효성체크
      if(new RegExp(/^[0-9]{1,6}$/).test(emp_no)==false){
            alert("사원번호 숫자 1-6자를 입력해주세요.")
            emp_noObj.val("");
            emp_noObj.focus();
            return false;
        }
      ...
      //이메일 유효성체크
      if(new RegExp(/^[A-Za-z0-9_\.\-]+@[A-Za-z0-9\-]+\.[A-Za-z0-9\-]+/).test(emp_email)==false){
      ...
      //퇴사일자 유효성체크
      if(new RegExp(/^[0-9]{8}$/).test(emp_retire)==false){
            alert("퇴사일자 8자리를 입력해주세요.")
            emp_retireObj.val("");
            emp_retireObj.focus();
            return false;
        }
      ...
      <div class="tab-contents" data-tab-contents="DEFAULT" data-tab-contents-group="SIDE_MENU">
        ...
        <ul class="menu-accordion">
          <li>
            ...
            <a href="adNotice.jsp"><span class="label">공지사항</span></a>
          </li>
          <li class="tree-view">
    ...
    <div id="contents-wrapper">
      <div class="content-header" style="z-index:1; cursor:default;">
        <div class="content-title-bar" style="z-index:2; cursor:default;">
          <h5>사원등록<button class="btn btn-sm btn-icon"><span class="icon"></span></button></h5>
          ...
          <div class="tools responsive-except-desktop" style="z-index:3; cursor:default;">
            <div class="tools-group" style="z-index:4; cursor:default;">
              ...
              <button class="tool-item" disabled style="cursor:default;  position: inherit; z-index: 5 !important;">
                <span class="icon"><i class="Licon ico-datareset"></i></span>
                <span class="label">조회</span>
              </button>
              </a>
              <a href="#" class="tool-item saveBtn">
              <button class="tool-item" disabled style="cursor:default;  position: inherit; z-index: 5 !important;">
          ...
          <section class="mg-t-20u">      
            ...
            <div class="box signup">
              <div class="input-container input-container-md mg-t-4u mar">
                <label>프로필사진<em class="txt-error">*</em></label>                
                ...
                <input type="button" value="미리보기" onclick="ResizeImage()"/>      
                  ...
                  <div class="input-container input-container-md mg-t-4u">
                    ...
                    <div class="input-group">
                      ...
                      <div class="input-group-tools">
                        <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                        <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                  ...
                  <div class="input-container input-container-md mg-t-4u">
                    <div class="input-container input-container-md">
                      ...
                      <div class="input-group">
                        <input type="text" placeholder="생년월일을 입력해주세요." class="input-box emp_birth" name="emp_birth">
                        <div class="input-group-tools">
                          <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                          <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                          <button type="button" class="clear"><i class="material-icons">cancel</i></button>
                  ...
                  <div class="input-container input-container-md mg-t-4u">
                    <div class="input-container input-container-md">
                      ...
                      <div class="input-group">
                        <input type="text" placeholder="주민등록번호를 입력해주세요." class="input-box emp_jumin" name="emp_jumin">
                        <div class="input-group-tools">                     
                          <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                          <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                          <button type="button" class="clear"><i class="material-icons">cancel</i></button>
                  ...
                  <td style="width: 50%;">
                    <div class="input-container input-container-md mg-t-4u">
                      <div class="input-container input-container-md">
                        ...
                        <div class="input-group">
                          <input type="text" placeholder="부서명을 입력해주세요." class="input-box emp_part" name="emp_part">
                          <div class="input-group-tools">
                            <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                            <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                            <button type="button" class="clear"><i class="material-icons">cancel</i></button>
                  ...
                  <td style="width: 50%;">
                    <div class="input-container input-container-md mg-t-4u">
                      <div class="input-container input-container-md">
                        ...
                        <div class="input-group">
                          <input type="text" placeholder="직급명을 입력해주세요." class="input-box emp_jikup" name="emp_jikup">
                          <div class="input-group-tools">
                            <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                            <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                            <button type="button" class="clear"><i class="material-icons">cancel</i></button>
              ...
              <div class="input-container input-container-md mg-t-4u">
                ...
                <div class="input-group">
                  <input type="text" placeholder="'-'없이 입력해 주세요." class="input-box emp_phone" name="emp_phone">
                  <div class="input-group-tools">
                ...
                <div class="col-xs-12 col-md-7">
                  <div class="fix-width-column right bottom w-140 mg-t-4u">
                    <div class="input-container input-container-md">
                      ...
                      <div class="input-group">
                        <input type="text" placeholder="주소검색을 눌러주세요." class="input-box emp_loc" id="sample6_address" placeholder="주소" name="emp_loc">
                        <div class="input-group-tools">
                          <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                          <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                          <button type="button" class="clear"><i class="material-icons">cancel</i></button>
                    ...
                    <div class="pd-l-2u">
                      ...
                      <button type="button" class="btn btn-md btn-secondary btn-container btn-full" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
              ...
              <div class="input-container input-container-md mg-t-2u">
                <div class="input-group">
                  ...
                  <input type="text"  class="input-box emp_detailloc" id="sample6_detailAddress" placeholder="상세주소" name="emp_detailloc">
                  <div class="input-group-tools">
                    <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                    <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                    <button type="button" class="clear"><i class="material-icons">cancel</i></button>
              ...
              <div class="input-container input-container-md mg-t-4u">
                ...
                <div class="input-group">
                  <input type="text" placeholder="퇴사일자를 입력해주세요." class="input-box emp_retire" name="emp_retire">
                  <div class="input-group-tools">
                    <button type="button" class="option error"><i class="Licon size-24 ico-warning"></i></button>
                    <button type="button" class="option success"><i class="Licon size-24 ico-check"></i></button>
                    <button type="button" class="clear"><i class="material-icons">cancel</i></button>
              ...
              <div class="txt-right">
                <a href="javascript:location.reload();"><button type="button" class="btn btn-md btn-gray btn-container wth-100">
                  <span class="label">취소</span>
                </button></a>
                <a class="regBtn" href="#"><button type="button" class="btn btn-md btn-primary btn-container wth-100">
